...
const handleSubmit = async () => {
  ...
  try {
    ...
    notificationMessage.value = 'Successfully subscribed! You\'ll receive updates about our upcoming programs.'
...
const validateField = (field: keyof NewsletterFormData) => {
  if (field === 'email') {
  ...
  <div class="max-w-lg mx-auto">
    ...
    >
      ...
      <p class="text-xs text-gray-500 text-center">
        Stay informed about our upcoming investment education programs and events.
      </p>
    </form>
  </div>
</template>
